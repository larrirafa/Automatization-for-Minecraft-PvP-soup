...
def remouse():
    ...
    time.sleep(0.08)
    pa.moveTo(x=964, y=580, duration=0) #Clicando no pote
    pa.rightClick()
    ...
    with pa.hold('shift'):
        ...
        pa.moveTo(x=1013, y=467, duration=0)#puxando recraft (cogu marrom)
        pa.click()

        pa.moveTo(x=1011, y=506, duration=0)#puxando recraft (cogu Vermelho)
        pa.click()
